            ...
            <div className="flex items-center justify-between">
                <div className="mx-7">
                    <h4 className="text-4xl uppercase font-bold">
                        Ra<span className="text-cyan-600">fi</span>Kul
                    </h4>
                </div>
                ...
                <div className={`md:hidden text-gray-900 absolute w-1/2 h-screen px-7 py-2  font-medium bg-white top-0 duration-300 ${open ? "right-0" : "right-[-100%]"}`}>
