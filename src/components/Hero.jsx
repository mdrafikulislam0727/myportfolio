    ...
    return (
        <section
           ...
           <div className='flex-1 flex items-center justify-center h-full'>
                <img src={img} alt=""  className='md:w-11/12 h-1/2 object-cover rounded-full rounded-e-full border-4 border-cyan-600 shadow-lg'/>
           </div>
                ...
                <div className='md:text-left text-center'>
                    <h1 className='md:text-5xl text-2xl md:leading-normal leading-10 text-white font-bold '>
                        <span className='text-cyan-600 md:text-5xl text-4xl'>
                            ...
                            My Name is <span>MD Rafikul Islam</span>
                    </h1>
